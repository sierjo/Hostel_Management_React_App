        ...
        <div className="home">
            ...
            <section>
                <header className="header-banner">
                    <img src="./assets/images/hotel.webp" alt="Hostel" className="header-image" />
                    <div className="overlay"></div>
                    <div className="animated-texts overlay-content">
                        <h1>
                            Welcome to <span className="phegon-color">Hostel</span>
                        </h1><br />
            ...
            <h2 className="home-services">Services at <span className="phegon-color">Hostel</span></h2>

            {/* SERVICES SECTION */}
            <section className="service-section"><div className="service-card">
                <img src=".public/assets/images/cd.jpg" alt="Air Conditioning" />
                ...
                <div className="service-card">
                    <img src=".public/assets/images/mini-bar.jpg" alt="Mini Bar" />
                    <div className="service-details">
                ...
                <div className="service-card">
                    <img src=".public/assets/images/parkking.jpg" alt="Parking" />
                    <div className="service-details">
                ...
                <div className="service-card">
                    <img src=".public/assets/images/Wi-Fi.jpg" alt="WiFi" />
